  ...
  <?php include 'header-product.php'; ?>
           ...
           <!--    Right Main -->
            <div class="col-lg-8 liam">
                <img src="img/zc_hanging_hooks_large.jpg" class="img-fluid table-photo">
                <div class="table-bar">
                                "ZC" HOOKS 
                </div>
                ...
                <div class="table-product-details"> 
                    <ul> 
                        ...
                        <li>Hooks are stocked in 0.044", 0.062" and 0.076" wire diamteters.</li>
                        <li>Custom sizes and lengths are available on special order.</li> 
                           ...
                           <tr>
                            <?php
                               $link = mysqli_connect("sql5c25c.carrierzone.com", "argonusaco889229", "argon2018", "argon2018_argonusaco889229");
                                ...
                                $query = "SELECT * FROM  zc_hanging_hooks";
